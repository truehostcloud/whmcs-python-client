...
from whmcs_client.api_response import ApiResponse, T as ApiResponseT
import whmcs_client.models
from whmcs_client import rest
from whmcs_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(whmcs_client.models, klass)
