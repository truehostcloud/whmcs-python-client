...
class DefaultApi:
    ...
    def api_post(
        self,
        api_post_request: ApiPostRequest,
        ...
        :param api_post_request: (required)
        :type api_post_request: ApiPostRequest
    ...
    def _api_post_serialize(
        ...
        if api_post_request is not None:
            _body_params = api_post_request
