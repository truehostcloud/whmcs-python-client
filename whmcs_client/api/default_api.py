...
class DefaultApi(object):
    ...
    def api_post(self, **kwargs):  # noqa: E501
        ...
        Executes a WHMCS API action. The specific action is determined by the 'action' field in the request body. Different actions have different required and optional parameters.   # noqa: E501
