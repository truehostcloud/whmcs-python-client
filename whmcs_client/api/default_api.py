...
class DefaultApi:
    ...
    def get_clients(
        ...
        limitnum: Annotated[Optional[StrictInt], Field(description="The number of records to return")] = None,
        sorting: Annotated[Optional[StrictStr], Field(description="The direction to sort the results. ASC or DESC.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Optional desired Client Status. 'Active', 'Inactive', or 'Closed'.")] = None,
        search: Annotated[Optional[StrictStr], Field(description="The search term to look for at the start of email, firstname, lastname, fullname or companyname")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="The column to order by. id, firstname, lastname, companyname, email, groupid, datecreated, status")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param limitnum: The number of records to return
        :type limitnum: int
        :param sorting: The direction to sort the results. ASC or DESC.
        :type sorting: str
        :param status: Optional desired Client Status. 'Active', 'Inactive', or 'Closed'.
        :type status: str
        :param search: The search term to look for at the start of email, firstname, lastname, fullname or companyname
        :type search: str
        :param orderby: The column to order by. id, firstname, lastname, companyname, email, groupid, datecreated, status
        :type orderby: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_clients_serialize(
        ...
        if sorting is not None:
            _form_params.append(('sorting', sorting))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api.php?action=GetClients',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_products(
        ...
        accesskey: Annotated[Optional[StrictStr], Field(description="Optional API access key")] = None,
        responsetype: Annotated[Optional[StrictStr], Field(description="Response format")] = None,
        pid: Annotated[Optional[StrictStr], Field(description="Obtain a specific product id configuration. Can be a comma-separated list of ids.")] = None,
        gid: Annotated[Optional[StrictInt], Field(description="Retrieve products in a specific group id")] = None,
        module: Annotated[Optional[StrictStr], Field(description="Retrieve products utilising a specific module")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param responsetype: Response format
        :type responsetype: str
        :param pid: Obtain a specific product id configuration. Can be a comma-separated list of ids.
        :type pid: str
    ...
    def _get_products_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api.php?action=GetProducts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
