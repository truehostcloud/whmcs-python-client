...
class DefaultApi(object):
    ...
    def add_client(self, **kwargs):  # noqa: E501
        ...
        Creates a new client account in WHMCS  # noqa: E501
    ...
    def add_order(self, **kwargs):  # noqa: E501
        """Create a new order  # noqa: E501

        Places a new order for products/services  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_order(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.add_order_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.add_order_with_http_info(**kwargs)  # noqa: E501
            return data

    def add_order_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new order  # noqa: E501

        Places a new order for products/services  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_order_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AddOrderResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_client(self, **kwargs):  # noqa: E501
        """Update client details  # noqa: E501

        Modifies an existing client's information  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_client(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_client_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_client_with_http_info(**kwargs)  # noqa: E501
            return data

    def update_client_with_http_info(self, **kwargs):  # noqa: E501
        """Update client details  # noqa: E501

        Modifies an existing client's information  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_client_with_http_info(async_req=True)
        >>> result = thread.get()
