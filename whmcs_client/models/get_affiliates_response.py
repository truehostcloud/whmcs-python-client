...
class GetAffiliatesResponse(BaseModel):
    ...
    affiliates: Optional[GetAffiliatesResponseAllOfAffiliates] = None
    __properties: ClassVar[List[str]] = ["result", "message", "totalresults", "startnumber", "numreturned", "affiliates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of affiliates
        if self.affiliates:
            _dict['affiliates'] = self.affiliates.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "affiliates": GetAffiliatesResponseAllOfAffiliates.from_dict(obj["affiliates"]) if obj.get("affiliates") is not None else None
        })
        return _obj
