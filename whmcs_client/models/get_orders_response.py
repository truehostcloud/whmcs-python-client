...
class GetOrdersResponse(BaseModel):
    ...
    orders: Optional[Any] = Field(default=None, description="The orders collection")
    __properties: ClassVar[List[str]] = ["result", "message", "totalresults", "startnumber", "numreturned", "orders"]
