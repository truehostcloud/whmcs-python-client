...
class GetPaymentMethodsResponse(BaseModel):
    ...
    paymentmethods: Optional[GetPaymentMethodsResponseAllOfPaymentmethods] = None
    __properties: ClassVar[List[str]] = ["result", "message", "totalresults", "paymentmethods"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of paymentmethods
        if self.paymentmethods:
            _dict['paymentmethods'] = self.paymentmethods.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentmethods": GetPaymentMethodsResponseAllOfPaymentmethods.from_dict(obj["paymentmethods"]) if obj.get("paymentmethods") is not None else None
        })
        return _obj
