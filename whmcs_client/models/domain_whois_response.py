...
class DomainWhoisResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The registration status")
    whois: Optional[StrictStr] = Field(default=None, description="Whois server response")
    __properties: ClassVar[List[str]] = ["result", "message", "status", "whois"]
