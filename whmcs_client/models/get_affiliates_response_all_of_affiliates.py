...
class GetAffiliatesResponseAllOfAffiliates(BaseModel):
    """
    GetAffiliatesResponseAllOfAffiliates
    """ # noqa: E501
    affiliate: Optional[List[AffiliateInfo]] = Field(default=None, description="The affiliates entries returned")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in affiliate (list)
        _items = []
        if self.affiliate:
            for _item_affiliate in self.affiliate:
                if _item_affiliate:
                    _items.append(_item_affiliate.to_dict())
            _dict['affiliate'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "affiliate": [AffiliateInfo.from_dict(_item) for _item in obj["affiliate"]] if obj.get("affiliate") is not None else None
        })
        return _obj
