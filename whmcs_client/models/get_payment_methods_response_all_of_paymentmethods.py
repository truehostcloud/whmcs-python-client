...
class GetPaymentMethodsResponseAllOfPaymentmethods(BaseModel):
    """
    GetPaymentMethodsResponseAllOfPaymentmethods
    """ # noqa: E501
    paymentmethod: Optional[List[PaymentMethodInfo]] = Field(default=None, description="An array of available payment methods")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in paymentmethod (list)
        _items = []
        if self.paymentmethod:
            for _item_paymentmethod in self.paymentmethod:
                if _item_paymentmethod:
                    _items.append(_item_paymentmethod.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paymentmethod": [PaymentMethodInfo.from_dict(_item) for _item in obj["paymentmethod"]] if obj.get("paymentmethod") is not None else None
        })
        return _obj
