...
class UserInfo(BaseModel):
    ...
    is_owner: Optional[StrictBool] = Field(default=None, description="Whether the user is the account owner")
    __properties: ClassVar[List[str]] = ["id", "name", "email", "is_owner"]
