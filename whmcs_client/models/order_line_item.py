...
class OrderLineItem(BaseModel):
    ...
    OrderLineItem
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The line item type (product, domain, addon)")
    product: Optional[StrictStr] = Field(default=None, description="The product name")
    domain: Optional[StrictStr] = Field(default=None, description="The associated domain")
    ...
    status: Optional[StrictStr] = Field(default=None, description="The line item status")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "product", "domain", "billingcycle", "amount", "status"]
