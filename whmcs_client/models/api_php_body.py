...
class ApiPhpBody(object):
    ...
    discriminator_value_class_map = {
            'AddClient'.lower(): '#/components/schemas/AddClientRequest',
            'UpdateClient'.lower(): '#/components/schemas/UpdateClientRequest',
            'AddOrder'.lower(): '#/components/schemas/AddOrderRequest',
            'UpdateClientRequest'.lower(): 'UpdateClient',
            'AddOrderRequest'.lower(): 'AddOrder',
            'AddClientRequest'.lower(): 'AddClient',
    }

    def __init__(self):  # noqa: E501
        """ApiPhpBody - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiPhpBody):
            return False
