...
class PaymentMethodInfo(BaseModel):
    ...
    PaymentMethodInfo
    """ # noqa: E501
    module: Optional[StrictStr] = Field(default=None, description="The payment method module name")
    displayname: Optional[StrictStr] = Field(default=None, description="The payment method display name")
    __properties: ClassVar[List[str]] = ["module", "displayname"]
