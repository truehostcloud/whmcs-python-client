...
class GetCurrenciesResponseAllOfCurrencies(BaseModel):
    """
    GetCurrenciesResponseAllOfCurrencies
    """ # noqa: E501
    currency: Optional[List[CurrencyInfo]] = Field(default=None, description="Array of currency information")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currency": [CurrencyInfo.from_dict(_item) for _item in obj["currency"]] if obj.get("currency") is not None else None
        })
        return _obj
