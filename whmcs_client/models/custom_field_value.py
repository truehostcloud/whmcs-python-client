...
class CustomFieldValue(BaseModel):
    ...
    CustomFieldValue
    """ # noqa: E501
    id: Optional[CustomFieldValueId] = None
    value: Optional[StrictStr] = Field(default=None, description="Custom field value")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": CustomFieldValueId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "value": obj.get("value")
        })
