...
class GetClientsResponseAllOfClients(BaseModel):
    """
    GetClientsResponseAllOfClients
    """ # noqa: E501
    client: Optional[List[ClientInfo]] = Field(default=None, description="Array of client information")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "client": [ClientInfo.from_dict(_item) for _item in obj["client"]] if obj.get("client") is not None else None
        })
        return _obj
