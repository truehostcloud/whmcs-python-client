...
class WHMCSSuccessResponse(object):
    ...
    discriminator_value_class_map = {
            'AddClient'.lower(): '#/components/schemas/AddClientResponse',
            'UpdateClient'.lower(): '#/components/schemas/UpdateClientResponse',
            'AddOrder'.lower(): '#/components/schemas/AddOrderResponse',
            'AddClientResponse'.lower(): 'AddClient',
            'UpdateClientResponse'.lower(): 'UpdateClient',
            'AddOrderResponse'.lower(): 'AddOrder',
    }
