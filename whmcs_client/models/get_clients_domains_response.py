...
class GetClientsDomainsResponse(BaseModel):
    """
    GetClientsDomainsResponse
    """ # noqa: E501
    result: Optional[StrictStr] = None
    message: Optional[StrictStr] = Field(default=None, description="Response message")
    clientid: Optional[StrictInt] = Field(default=None, description="The specific client id searched for")
    domainid: Optional[StrictInt] = Field(default=None, description="The specific domain id searched for")
    ...
    numreturned: Optional[StrictInt] = Field(default=None, description="The total number of results returned")
    domains: Optional[GetClientsDomainsResponseAllOfDomains] = None
    __properties: ClassVar[List[str]] = ["result", "message", "clientid", "domainid", "totalresults", "startnumber", "numreturned", "domains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domains": GetClientsDomainsResponseAllOfDomains.from_dict(obj["domains"]) if obj.get("domains") is not None else None
        })
        return _obj
