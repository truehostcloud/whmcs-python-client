...
class DomainGetNameserversResponse(BaseModel):
    """
    DomainGetNameserversResponse
    """ # noqa: E501
    result: Optional[StrictStr] = None
    message: Optional[StrictStr] = Field(default=None, description="Response message")
    ns1: Optional[StrictStr] = Field(default=None, description="The first nameserver on the domain")
    ns2: Optional[StrictStr] = Field(default=None, description="The second nameserver on the domain")
    ns3: Optional[StrictStr] = Field(default=None, description="The third nameserver on the domain")
    ns4: Optional[StrictStr] = Field(default=None, description="The fourth nameserver on the domain")
    ns5: Optional[StrictStr] = Field(default=None, description="The fifth nameserver on the domain")
    __properties: ClassVar[List[str]] = ["result", "message", "ns1", "ns2", "ns3", "ns4", "ns5"]
