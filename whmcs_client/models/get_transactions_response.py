...
class GetTransactionsResponse(BaseModel):
    ...
    transactions: Optional[GetTransactionsResponseAllOfTransactions] = None
    __properties: ClassVar[List[str]] = ["result", "message", "totalresults", "startnumber", "numreturned", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": GetTransactionsResponseAllOfTransactions.from_dict(obj["transactions"]) if obj.get("transactions") is not None else None
        })
        return _obj
