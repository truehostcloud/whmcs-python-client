...
class GetTransactionsResponseAllOfTransactions(BaseModel):
    """
    GetTransactionsResponseAllOfTransactions
    """ # noqa: E501
    transaction: Optional[List[TransactionInfo]] = Field(default=None, description="An array of transactions matching the criteria passed")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction": [TransactionInfo.from_dict(_item) for _item in obj["transaction"]] if obj.get("transaction") is not None else None
        })
        return _obj
