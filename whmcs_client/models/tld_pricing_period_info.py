...
class TldPricingPeriodInfo(BaseModel):
    """
    TldPricingPeriodInfo
    """ # noqa: E501
    days: Optional[StrictInt] = Field(default=None, description="The number of days in the period")
    price: Optional[StrictStr] = Field(default=None, description="The price for the period")
    __properties: ClassVar[List[str]] = ["days", "price"]
