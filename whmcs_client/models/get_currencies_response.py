...
class GetCurrenciesResponse(BaseModel):
    ...
    totalresults: Optional[StrictInt] = Field(default=None, description="The total number of currencies available")
    currencies: Optional[GetCurrenciesResponseAllOfCurrencies] = None
    __properties: ClassVar[List[str]] = ["result", "message", "totalresults", "currencies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currencies": GetCurrenciesResponseAllOfCurrencies.from_dict(obj["currencies"]) if obj.get("currencies") is not None else None
        })
        return _obj
