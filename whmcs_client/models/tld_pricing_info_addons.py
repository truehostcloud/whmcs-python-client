...
class TldPricingInfoAddons(BaseModel):
    """
    TldPricingInfoAddons
    """ # noqa: E501
    dns: Optional[StrictBool] = Field(default=None, description="Whether DNS addon pricing is available")
    email: Optional[StrictBool] = Field(default=None, description="Whether email addon pricing is available")
    idprotect: Optional[StrictBool] = Field(default=None, description="Whether ID protection addon pricing is available")
    __properties: ClassVar[List[str]] = ["dns", "email", "idprotect"]
