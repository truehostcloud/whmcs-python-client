...
class TestDomainWhoisResponse(unittest.TestCase):
    """DomainWhoisResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainWhoisResponse:
        """Test DomainWhoisResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainWhoisResponse`
        """
        model = DomainWhoisResponse()
        if include_optional:
    ...
    def testDomainWhoisResponse(self):
        """Test DomainWhoisResponse"""
