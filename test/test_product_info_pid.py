...
class TestProductInfoPid(unittest.TestCase):
    """ProductInfoPid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoPid:
        """Test ProductInfoPid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoPid`
        """
        model = ProductInfoPid()
        if include_optional:
