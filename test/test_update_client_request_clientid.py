...
class TestUpdateClientRequestClientid(unittest.TestCase):
    """UpdateClientRequestClientid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateClientRequestClientid:
        """Test UpdateClientRequestClientid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateClientRequestClientid`
        """
        model = UpdateClientRequestClientid()
        if include_optional:
            return UpdateClientRequestClientid(
            )
        else:
            return UpdateClientRequestClientid(
        )
    ...
    def testUpdateClientRequestClientid(self):
        """Test UpdateClientRequestClientid"""
