...
class TestInvoiceInfoPaymethodid(unittest.TestCase):
    """InvoiceInfoPaymethodid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceInfoPaymethodid:
        """Test InvoiceInfoPaymethodid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceInfoPaymethodid`
        """
        model = InvoiceInfoPaymethodid()
        if include_optional:
            return InvoiceInfoPaymethodid(
            )
        else:
            return InvoiceInfoPaymethodid(
        )
    ...
    def testInvoiceInfoPaymethodid(self):
        """Test InvoiceInfoPaymethodid"""
