...
class TestTldPricingPeriodInfo(unittest.TestCase):
    """TldPricingPeriodInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TldPricingPeriodInfo:
        """Test TldPricingPeriodInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TldPricingPeriodInfo`
        """
        model = TldPricingPeriodInfo()
        if include_optional:
            return TldPricingPeriodInfo(
                days = 56,
                price = ''
            )
        else:
    ...
    def testTldPricingPeriodInfo(self):
        """Test TldPricingPeriodInfo"""
