...
class TestProductInfoOrderid(unittest.TestCase):
    """ProductInfoOrderid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoOrderid:
        """Test ProductInfoOrderid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoOrderid`
        """
        model = ProductInfoOrderid()
        if include_optional:
            return ProductInfoOrderid(
            )
        else:
            return ProductInfoOrderid(
        )
    ...
    def testProductInfoOrderid(self):
        """Test ProductInfoOrderid"""
