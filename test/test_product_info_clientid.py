...
class TestProductInfoClientid(unittest.TestCase):
    """ProductInfoClientid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoClientid:
        """Test ProductInfoClientid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoClientid`
        """
        model = ProductInfoClientid()
        if include_optional:
            return ProductInfoClientid(
            )
        else:
            return ProductInfoClientid(
        )
    ...
    def testProductInfoClientid(self):
        """Test ProductInfoClientid"""
