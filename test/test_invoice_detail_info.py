...
class TestInvoiceDetailInfo(unittest.TestCase):
    """InvoiceDetailInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceDetailInfo:
        """Test InvoiceDetailInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceDetailInfo`
        """
        model = InvoiceDetailInfo()
        if include_optional:
    ...
    def testInvoiceDetailInfo(self):
        """Test InvoiceDetailInfo"""
