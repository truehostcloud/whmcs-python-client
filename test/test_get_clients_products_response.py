...
class TestGetClientsProductsResponse(unittest.TestCase):
    """GetClientsProductsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetClientsProductsResponse:
        """Test GetClientsProductsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetClientsProductsResponse`
        """
        model = GetClientsProductsResponse()
        if include_optional:
    ...
    def testGetClientsProductsResponse(self):
        """Test GetClientsProductsResponse"""
