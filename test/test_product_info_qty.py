...
class TestProductInfoQty(unittest.TestCase):
    """ProductInfoQty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoQty:
        """Test ProductInfoQty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoQty`
        """
        model = ProductInfoQty()
        if include_optional:
            return ProductInfoQty(
            )
        else:
            return ProductInfoQty(
        )
