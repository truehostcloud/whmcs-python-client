...
class TestProductInfoId(unittest.TestCase):
    """ProductInfoId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoId:
        """Test ProductInfoId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoId`
        """
        model = ProductInfoId()
        if include_optional:
