...
class TestGetInvoicesDetailsResponse(unittest.TestCase):
    """GetInvoicesDetailsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesDetailsResponse:
        """Test GetInvoicesDetailsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesDetailsResponse`
        """
        model = GetInvoicesDetailsResponse()
        if include_optional:
            return GetInvoicesDetailsResponse(
                result = 'success',
                message = '',
                totalresults = 56,
                startnumber = 56,
    ...
    def testGetInvoicesDetailsResponse(self):
        """Test GetInvoicesDetailsResponse"""
