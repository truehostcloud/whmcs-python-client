...
class TestCustomFieldValueId(unittest.TestCase):
    """CustomFieldValueId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldValueId:
        """Test CustomFieldValueId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldValueId`
        """
        model = CustomFieldValueId()
        if include_optional:
    ...
    def testCustomFieldValueId(self):
        """Test CustomFieldValueId"""
