...
class TestTldPricingInfoAddons(unittest.TestCase):
    """TldPricingInfoAddons unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TldPricingInfoAddons:
        """Test TldPricingInfoAddons
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TldPricingInfoAddons`
        """
        model = TldPricingInfoAddons()
        if include_optional:
            return TldPricingInfoAddons(
                dns = True,
                email = True,
                idprotect = True
            )
    ...
    def testTldPricingInfoAddons(self):
        """Test TldPricingInfoAddons"""
