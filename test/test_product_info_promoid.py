...
class TestProductInfoPromoid(unittest.TestCase):
    """ProductInfoPromoid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoPromoid:
        """Test ProductInfoPromoid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoPromoid`
        """
        model = ProductInfoPromoid()
        if include_optional:
            return ProductInfoPromoid(
            )
        else:
            return ProductInfoPromoid(
        )
    ...
    def testProductInfoPromoid(self):
        """Test ProductInfoPromoid"""
