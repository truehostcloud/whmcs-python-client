...
class TestUserCollectionUser(unittest.TestCase):
    """UserCollectionUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCollectionUser:
        """Test UserCollectionUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserCollectionUser`
        """
        model = UserCollectionUser()
        if include_optional:
            return UserCollectionUser(
                id = 56,
                name = '',
                email = '',
                is_owner = True
    ...
    def testUserCollectionUser(self):
        """Test UserCollectionUser"""
