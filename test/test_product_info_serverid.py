...
class TestProductInfoServerid(unittest.TestCase):
    """ProductInfoServerid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductInfoServerid:
        """Test ProductInfoServerid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductInfoServerid`
        """
        model = ProductInfoServerid()
        if include_optional:
            return ProductInfoServerid(
            )
        else:
            return ProductInfoServerid(
        )
    ...
    def testProductInfoServerid(self):
        """Test ProductInfoServerid"""
